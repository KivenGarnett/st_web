...
<script type="text/javascript">
	...
	function pay() {
		...
		$.ajax({
			...
			success : function(data) {
				alert("支付成功!");
				window.location.href = "<%=request.getContextPath()%>/jsp/ordermes.jsp";
			}
		});
	}
</script>
					...
					<br>
							<div style="background: #eeeeee; width: 100%; height: 47px;">
										...
										<div style="margin-top: 12px;">
											...
											<td>
											<input class="am-btn am-btn-danger anniu" style="width: 90px;margin-top: 1px;" onclick="pay()"  value="付款" readonly="readonly">
										</td></tr>
										</table>
									</div>
				</div>
