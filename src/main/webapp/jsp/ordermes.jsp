...
function showadderss(data) {
	...
	for (var i = 0; i < len; i++) {
		var row = rows[i];
		var s1 = '<div class="icon-add"></div><p ><span class="new-txt">收货人:'+row.userName+'</span><br><br><span class="new-txt-rd2">电话:'+row.userTel+'</span></p>';
		var s2 = '<br><div class="new-mu_l2a new-p-re"><p><span class="title">收货地址：</span>';
		var s3 = '<span class="province">' + row.userSheng
						...
						<div class="order-infoaside">
							<div class="order-logistics">
									...
									<div class="latest-logistics">
										<p class="text">已签收,签收人是本人签收，感谢使用顺风物流，期待可以再次为您服务</p>
										<div class="time-list">
											<span class="date">2018-1-10</span><span class="week">周三</span><span class="time">15:35:42</span>
										</div>
										<div class="inquire">
											<span class="package-detail">物流：顺风快递</span>
