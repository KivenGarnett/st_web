	...
	function add(sta) {
		...
		$
				.ajax({
					...
					type : "POST",
					data : "comNum=" + comNum + "&comId=" + comId + "&userId="
							+ userId,
					dataType : "text",
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="../image/fengmian.jpg">
							<img src="../image/fengmian.jpg" alt="细节展示放大镜特效" class="jqzoom" />
						</a>
					</div>
					<ul class="tb-thumb" id="thumblist">
						<li class="tb-selected" style="float: left;margin-left: 5px;">
							<div class="tb-pic tb-s40">
								<a href="../image/fengmian2.jpg">
									<img src="../image/fengmian2.jpg" alt="细节展示放大镜特效" class="jqzoom" />
								</a>
							</div>
						</li>
						<li style="float: left;margin-left: 5px;">
							<div class="tb-pic tb-s40">
								<a href="../image/fengmian3.jpg">
									<img src="../image/fengmian3.jpg" alt="细节展示放大镜特效" class="jqzoom" />
								</a>
							</div>
						</li>
						<li style="float: left;margin-left: 5px;">
							<div class="tb-pic tb-s40">
								<a href="../image/fengmian4.jpg" alt="细节展示放大镜特效" class="jqzoom" />
									<img src="../image/fengmian4.jpg">
								</a>
							</div>
						</li>
					</ul>
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							...
							<dd>
								<em>¥</em>
								<b class="sys_item_price">1180.00</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							...
							<dd>
								<em>¥</em>
								<b class="sys_item_mktprice">1350.00</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
											...
											<div class="theme-options">
												...
												<dd>
													...
													<span id="Stock" class="tb-hidden">
														库存
														<span class="stock" id="comrep">10</span>
														件
													</span>
												</dd>
											</div>
				...
				<ul class="am-avg-sm-3 am-tabs-nav am-nav am-nav-tabs">
					...
					<li>
						<a href="#">
							...
							<span class="index-needs-dt-txt">累计评论</span>
						</a>
